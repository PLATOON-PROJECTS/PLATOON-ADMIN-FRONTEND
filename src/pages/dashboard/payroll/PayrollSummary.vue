...
<template>
  ...
  >
    ...
    >
      <div
        class="box bg-white rounded-md md:w-[400px] w-auto p-6 flex flex-col items-center justify-center space-y-6"
      >
        <div>
          <svg
            width="69"
        ...
        <div class="text-center font-bold text-lg">Payroll Submitted</div>
        <div class="text-center text-sm text-gray-100 px-6">
          Payroll payment for
          <span class="font-bold">{{ summaryData.executionMonth }}</span> was
          successful. Check the status of each transaction once completed.
        </div>
      ...
      <div class="space-y-6">
        <div class="flex justify-between">
          <div class="flex space-x-5">
            ...
            <div>
              <h3 class="font-bold text-2xl whitespace-nowrap">Summary</h3>
              <p class="text-sm pt-1 font-semimedium whitespace-nowrap">
                <span class="text-black-200"
                  >Select Submit to proceed with Payroll transaction</span
                >
              </p>
            </div>
          </div>
                  ...
                  <tbody class="bg-white">
                    <tr class="text-black-100 border-b border-grey">
                      ...
                      <td class="py-4 whitespace-nowrap">
                        <div class="text-left flex flex-col">
                          <span class="text-sm font-semimedium"
                            >Platoon Inc LTD / Access Bank / 009876678876</span
                          >
                        </div>
                      </td>
                    </tr>
                    ...
                    <tr class="text-black-100 border-b border-grey">
                      ...
                      <td class="py-4 whitespace-nowrap">
                        <div class="text-left flex flex-col">
                          <span class="text-sm font-semimedium"
                            >₦{{ summaryData.totalSalaries }}</span
                          >
                        </div>
                      </td>
                    </tr>
