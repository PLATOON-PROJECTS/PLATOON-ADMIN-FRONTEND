  ...
  <div class="space-y-5">
    ...
    >
      ...
      >
        ...
        <div class="text-center font-bold text-lg">Payroll Approved</div>
    ...
    >
      ...
      >
        ...
        <div class="text-center font-bold text-lg">Payroll Declined</div>
        <div class="text-center text-sm text-gray-100 px-6">
          Payroll payment for
          <span class="font-bold">{{ summaryData.executionMonth }}</span> was
      ...
      <div class="grid lg:grid-cols-3 gap-3">
        ...
        <div class="h-full rounded-lg p-4 bg-blue-lighter space-y-8">
          ...
          <div class="space-y-5">
            <div class="items-center">
              <div class="flex flex-col">
                <span class="text-sm"
                  >₦ {{ currency(payrollData.pageItems?.totalSalaries) }}
                </span>
            ...
            <div class="items-center">
              <div class="flex flex-col">
                <span class="text-sm"
                  >₦ {{ currency(payrollData.pageItems?.totalSalaries) }}</span
                >
        ...
        <div class="h-full rounded-lg p-4 bg-blue-lighter space-y-8">
          ...
          <div class="space-y-5">
            ...
            <div class="items-center">
              <div class="flex flex-col">
                <span class="text-sm">₦ 18,000</span>
            ...
            <div class="items-center">
              <div class="flex flex-col">
                <span class="text-sm">₦7,0000 </span>
                <span class="text-xs text-gray-rgba-3">Total NSITF</span>
              </div>
            </div>
            <div class="items-center">
              <div class="flex flex-col">
                <span class="text-sm">#9,0000</span>
